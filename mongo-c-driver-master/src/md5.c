...
static void
mongo_md5_process(mongo_md5_state_t * pms,
		  const mongo_md5_byte_t * data /*[64] */ )
{
	mongo_md5_word_t
...
MONGO_EXPORT void
mongo_md5_append(mongo_md5_state_t * pms, const mongo_md5_byte_t * data,
		 int nbytes)
{
