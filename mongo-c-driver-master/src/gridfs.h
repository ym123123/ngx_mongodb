 ...
 */
MONGO_EXPORT int gridfs_find_query(gridfs * gfs, bson * query,
				   gridfile * gfile);
 ...
 *  @return MONGO_OK or MONGO_ERROR.
 */
MONGO_EXPORT int gridfs_find_filename(gridfs * gfs, const char *filename,
				      gridfile * gfile);
 ...
 *  @return - MONGO_OK or MONGO_ERROR.
 */
MONGO_EXPORT int gridfile_init(gridfs * gfs, bson * meta,
			       gridfile * gfile);
